...
- **Visible work crews** — builders face incomplete structures and swing hand-jointed hammers; lumber-mill workers walk to mature trees and chop with hatchets; stonecutters walk to live quarry nodes and mine with pickaxes. Skeletal work animation is limited to a 64 m viewing radius, with instanced villager LODs beyond it. Randomized work impacts fade out from 12–32 m and are disabled outside the close 32 m camera zoom.
...
| [Kenney Survival Kit](https://kenney.nl/assets/survival-kit) | Kenney | Low-poly worker hatchet, pickaxe, and hammer models | [CC0 1.0](public/assets/models/worker-tools/LICENSE.txt) |
