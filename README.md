...
- **Construction logistics** — placing a production, storage, service, faith, or trade building creates a cleared construction site and reserves its timber/stone cost without teleporting stock. Staffed storehouses are preferred dispatch points, staffed producers are fallbacks, and recognizable timber/stone carts unload into the intended site. Builders can advance only as far as delivered materials allow; the founding treasury is a paced bootstrap reserve for the first supply chain.
