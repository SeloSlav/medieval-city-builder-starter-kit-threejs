...
- **Delivery trips** — server-spawned road agents travel outbound, unload at the residence, and return; client renders worker-hauled wooden delivery carts along routes for firewood, water, and food hauls.
